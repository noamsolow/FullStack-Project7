    ...
    <div className="portal-page">
      ...
      <div className="settings-grid">
        ...
        <section className="card">
          ...
          <p className="muted">Delivery fees are calculated automatically from the campus-map distance.</p>
          <div className="zone-list">
            {vendor.deliveryZones.map((zone) => (
              <div key={zone.building_id}><span><strong>{zone.building_name}</strong><small>{zone.eta_min_minutes}–{zone.eta_max_minutes} min</small></span><strong>{formatMoney(zone.fee_agorot)}</strong></div>
            ))}
