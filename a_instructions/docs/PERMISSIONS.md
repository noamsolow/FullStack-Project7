...
| Capability | Customer | Vendor manager | Administrator |
|---|---:|---:|---:|
...
| Submit print job | Yes | No | No |
| Read print PDF | Own | Selected print center | Yes |
| Quote/update print job | No | Selected print center | Support access |
| Submit maintenance ticket | Yes | No | No |
| Read maintenance ticket | Own | No | All |
